...
//				+ "tool/ValidateImageServiceImp.ftl";
		...
		String UTIL_HTMLESCAPEUTILS = rootPath + "util/HtmlEscapeUtils.ftl";
		String UTIL_PINYIN4JUTIL = rootPath + "util/Pinyin4jUtil.ftl";
...
//						+ ".java", root);
		...
		fu.analysisTemplate(
				"templates",
				UTIL_HTMLESCAPEUTILS,
				project.getSrcPath() + File.separator
				+ ClassUtil.packageToPath(project.getOrg() + ".util")
				+ File.separator
				+ FileUtil.getFileNameWithoutExt(UTIL_HTMLESCAPEUTILS)
				+ ".java", root);
		fu.analysisTemplate(
				"templates",
				UTIL_PINYIN4JUTIL,
				project.getSrcPath() + File.separator
						+ ClassUtil.packageToPath(project.getOrg() + ".util")
						+ File.separator
						+ FileUtil.getFileNameWithoutExt(UTIL_PINYIN4JUTIL)
						+ ".java", root);
