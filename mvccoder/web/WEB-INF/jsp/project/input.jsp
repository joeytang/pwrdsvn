...
$(document).ready(function(){
    ...
    $("#dbId").formValidator({
    	empty :false,onShow:"请选择数据库",onFocus:"请选择数据库",onCorrect:"恭喜您,输入正确"
	}) ;
});
</script>
<form  class="form" id="inputForm" method="post" action="${ctx }/project/save" >
	...
	<table class="form-table" cellpadding="0" cellspacing="0">
		...
		<tr> 
	      ...
	      <td class="lefttd"  style="width:300px" >
			<input type="radio" name="needTomcatPlug" value="1" <c:if test="${null == project.needTomcatPlug || project.needTomcatPlug}"> checked="checked"</c:if>>是</input>
